...
// =============================================================
// 白芷
// 数据来源：库街区 Wiki entryId=1233429754977792000
...
const SKILLS = {
  skill1: {
    ...
    type: "normal",
    levelFrom: "常态攻击",
    levelMap: levelMap(0.3294, 0.3564, 0.3834, 0.4212, 0.4482, 0.4793, 0.5225, 0.5657, 0.6089, 0.6548)
  },
  skill2: {
    name: "第二段",
    type: "normal",
    levelFrom: "常态攻击",
    levelMap: levelMap(0.3952, 0.4276, 0.4601, 0.5054, 0.5378, 0.5751, 0.6269, 0.6788, 0.7306, 0.7857)
  },
  skill3: {
    name: "第三段",
    type: "normal",
    levelFrom: "常态攻击",
    levelMap: levelMap(0.4613, 0.4991, 0.5369, 0.5901, 0.6279, 0.6713, 0.7315, 0.7924, 0.8526, 0.917)
  },
  skill4: {
    name: "第四段",
    type: "normal",
  ...
  skill5: {
    ...
    type: "heavy",
    levelFrom: "常态攻击",
    levelMap: levelMap(0.2458, 0.266, 0.2861, 0.3143, 0.3345, 0.3577, 0.3899, 0.4221, 0.4544, 0.4886)
  },
  skill6: {
    name: "空中攻击",
    type: "normal",
    levelFrom: "常态攻击",
    levelMap: levelMap(0.3968, 0.4294, 0.4619, 0.5075, 0.54, 0.5774, 0.6295, 0.6816, 0.7336, 0.7889)
  },
  skill7: {
    name: "闪避反击",
    type: "normal",
    levelFrom: "常态攻击",
    levelMap: levelMap(0.8986, 0.9723, 1.046, 1.1491, 1.2228, 1.3075, 1.4254, 1.5433, 1.6612, 1.7865)
  },
  skill8: {
    name: "技能",
    type: "skill",
    levelFrom: "共鸣技能",
    levelMap: levelMap(0.0802, 0.0868, 0.0934, 0.1026, 0.1091, 0.1167, 0.1272, 0.1377, 0.1482, 0.1594)
  },
  skill9: {
    name: "治疗量",
    type: "skill",
    levelFrom: "共鸣技能",
    levelMap: levelMap(0.029, 0.0314, 0.0337, 0.0371, 0.0394, 0.0422, 0.046, 0.0498, 0.0536, 0.0576)
  },
  skill10: {
    name: "念意治疗量",
    type: "skill",
    levelFrom: "共鸣回路",
    levelMap: levelMap(0.0016, 0.0017, 0.0018, 0.002, 0.0021, 0.0023, 0.0025, 0.0027, 0.0029, 0.0031)
  },
  skill11: {
    name: "频隙回响",
    type: "liberation",
    levelFrom: "共鸣解放",
    levelMap: levelMap(0.0205, 0.0222, 0.0239, 0.0262, 0.0279, 0.0298, 0.0325, 0.0352, 0.0379, 0.0407)
  },
  skill12: {
    name: "频隙回响治疗量",
    type: "liberation",
    levelFrom: "共鸣解放",
    levelMap: levelMap(0.0142, 0.0153, 0.0165, 0.0181, 0.0193, 0.0206, 0.0225, 0.0243, 0.0262, 0.0282)
  },
  skill13: {
    name: "刹那合弥治疗量",
    type: "liberation",
    levelFrom: "共鸣解放",
    levelMap: levelMap(0.0126, 0.0136, 0.0147, 0.0161, 0.0171, 0.0183, 0.02, 0.0216, 0.0233, 0.0251)
  },
  skill14: {
    name: "技能",
    type: "intro",
  ...
  skill15: {
    ...
    type: "intro",
    levelFrom: "变奏技能",
    levelMap: levelMap(0.0038, 0.0041, 0.0044, 0.0048, 0.0051, 0.0055, 0.006, 0.0065, 0.007, 0.0075)
  }
};
