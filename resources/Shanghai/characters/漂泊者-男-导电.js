...
const WIKI_DETAIL = {"id": "1524702371185848320", "name": "漂泊者-男-导电", "orgFullName": "角色组 > 共鸣者", "lastUpdateTime": "2026-07-10", "currentVersion": "16.0"};
...
export default {
  ...
  async calc({ roleDetailData, panel, equipment, enemy, modules = {}, options }) {
    ...
    return { enemyName: enemy?.name || '无妄者', source: '库街区 Wiki entryId=1524702371185848320', items };
  }
};
